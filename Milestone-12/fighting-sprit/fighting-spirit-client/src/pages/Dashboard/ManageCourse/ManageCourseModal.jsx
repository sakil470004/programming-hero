        ...
        <dialog id="my_modal_1" className="modal">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg  mx-auto bg-white rounded-lg shadow-md p-6">
                ...
                <div className="mb-4">
                    ...
                    <input id="image" defaultValue={selected?.image} placeholder="Enter Photo URL" {...register("image", { required: true })} className="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    {errors.image && <span className="text-red-500 text-sm">Field required. Please check again.</span>}
                </div>
                <div className="mb-4">
                    <label htmlFor="price" className="block mb-2">Price</label>
                    <input id="price" defaultValue={selected?.price} placeholder="Enter Price" {...register("price", { required: true })} type="number" className="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                ...
                <div className="mb-4">
                    ...
                    <input id="availableSeats" defaultValue={selected?.availableSeats} placeholder="Enter Available Seats" {...register("availableSeats", { required: true })} type="number" className="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
